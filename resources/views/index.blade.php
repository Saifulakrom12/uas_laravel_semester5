...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
	...
	var marker1 = L.marker([-8.2991154,116.5043442]).addTo(mymap)
		.bindPopup("<b>Ini adalah Titik</b><br />Desa obel obel.").openPopup();
	var popup = L.popup();
		...
		var popupContent = "<p>Selamat datang di, Desaobel obel!</p>";
	...
	// TAMAN BERMAIN
	//##############################################//
	var sekolah = L.marker([-8.2667044,116.5399647, 116.5399647],{icon: sekolahIcon}).bindPopup("sd negri 1 obel obel <img src='img/wisata obel obel.jpg' alt='gumbang gannag' width='350px'/>");
